...
public class DatiFattureCollegate extends XmlEntity {
	...
	public XmlEntity init(Document dom) {
		this.riferimentoNumeroLinea 	= XMLUtil.parseStrictAttribute(dom, "datiFattureCollegate/@riferimentoNumeroLinea");
		this.idDocumento 				= XMLUtil.parseStrictAttribute(dom, "datiFattureCollegate/@idDocumento");
		this.data 						= XMLUtil.parseStrictAttribute(dom, "datiFattureCollegate/@data");
		this.numItem 					= XMLUtil.parseStrictAttribute(dom, "datiFattureCollegate/@numItem");
		this.codiceCommessaConvenzione 	= XMLUtil.parseStrictAttribute(dom, "datiFattureCollegate/@codiceCommessaConvenzione");
		this.codiceCUP 					= XMLUtil.parseStrictAttribute(dom, "datiFattureCollegate/@codiceCUP");
		this.codiceCIG 					= XMLUtil.parseStrictAttribute(dom, "datiFattureCollegate/@codiceCIG");
