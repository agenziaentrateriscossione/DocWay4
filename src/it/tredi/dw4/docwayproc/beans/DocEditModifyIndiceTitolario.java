...
public class DocEditModifyIndiceTitolario extends EditVoceIndice {
	...
	public DocEditModifyIndiceTitolario() throws Exception {
	...
	public String clearDocument() throws Exception {
		try {
			...
			buildSpecificShowdocPageAndReturnNavigationRule("@indice_titolario", response);
			return "showdoc@indice_titolario@reload";
		}
		catch (Throwable t) {
			handleErrorResponse(ErrormsgFormsAdapter.buildErrorResponse(t));
			formsAdapter.fillFormsFromResponse(formsAdapter.getLastResponse()); //restore delle form
