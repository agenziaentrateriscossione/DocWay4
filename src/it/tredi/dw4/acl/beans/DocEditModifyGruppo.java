...
public class DocEditModifyGruppo extends AclDocEdit {
	...
	public DocEditModifyGruppo() throws Exception {
	...
	public String saveDocument() throws Exception {
		try {
			...
			buildSpecificShowdocPageAndReturnNavigationRule("gruppo", response);
