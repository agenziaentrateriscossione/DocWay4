...
public class DocEditComune extends AclDocEdit {
	...
	public DocEditComune() throws Exception {
	...
	public String saveDocument() throws Exception {
		try {
			...
			if (fromLookup != null && fromLookup.equals("true")) {
				...
				setSessionAttribute("docEditComune", this);
				...
				ShowdocComune showdocComune = new ShowdocComune();
				showdocComune.getFormsAdapter().fillFormsFromResponse(response);
				showdocComune.init(response.getDocument());
				
				setSessionAttribute("showdocComune", showdocComune);		
