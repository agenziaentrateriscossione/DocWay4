 ...
 * @author mbernardini
 */
public class DocEditPartenzaFTR extends DocEditPartenza {
	private Fattura doc = new Fattura(); 
	
	public DocEditPartenzaFTR() throws Exception {
	...
	/**
	 * Ricalcolo dei totali degli importi dell'ordine (metodo chiamato in caso di modifica
	 * di un costo relativo all'ordine)
	 * 
	 * @return
	 * @throws Exception
	 */
