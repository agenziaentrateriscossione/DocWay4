...
public class ShowdocVarieFPNALGERIA extends ShowdocVarie {
	...
	public ShowdocVarieFPNALGERIA() throws Exception {
		super();
	}
	...
	public void reload() throws Exception {
		super._reload(FacesContext.getCurrentInstance().getExternalContext().getRequestContextPath() + "/docway/condotte/showdoc@varie@FPNALGERIA");
	}
	...
	public String verificaDoc() throws Exception {
		...
		return "condotte_docEdit@modify@varie_edit-show@FPNALGERIA";
	}
