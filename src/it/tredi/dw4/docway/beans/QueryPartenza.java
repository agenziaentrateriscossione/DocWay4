...
public class QueryPartenza extends DocWayQuery {
	private String xml;
	//campi di ricerca
	...
	private List<Option> partenza_mezzo_trasmissione_select;
	private List<Option> partenza_tipologia_select;
	...
	public QueryPartenza() throws Exception {
	...
	public void init(Document dom) {
		...
		this.partenza_mezzo_trasmissione_select = XMLUtil.parseSetOfElement(dom, "response/partenza_mezzo_trasmissione_select/option", new Option());
		this.partenza_tipologia_select = XMLUtil.parseSetOfElement(dom, "response/partenza_tipologia_select/option", new Option());
		this.listof_rep = XMLUtil.parseSetOfElement(dom, "response/listof_rep/repertorio[tabella/@tipo='P']", new Repertorio());
		...
		for (Iterator<Option> iterator = partenza_mezzo_trasmissione_select.iterator(); iterator.hasNext();) {
			Option option = (Option) iterator.next();
			if (option.getSelected().length()>0)
				mezzo_trasmissione = option.getValue();
		}
		for (Iterator<Option> iterator = partenza_tipologia_select.iterator(); iterator.hasNext();) {
			Option option = (Option) iterator.next();
			if (option.getSelected().length()>0)
	...
	public String createQuery() throws Exception{
        ...
        query +=  addQueryField("doc_tipo", "partenza");
...
//		 }
	...
	public void setPartenza_mezzo_trasmissione_select(
			List<Option> arrivo_mezzo_trasmissione_select) {
		this.partenza_mezzo_trasmissione_select = arrivo_mezzo_trasmissione_select;
	}

	public List<Option> getPartenza_mezzo_trasmissione_select() {
		return partenza_mezzo_trasmissione_select;
	}
	...
	public void setPartenza_tipologia_select(List<Option> arrivo_tipologia_select) {
		this.partenza_tipologia_select = arrivo_tipologia_select;
	}

	public List<Option> getPartenza_tipologia_select() {
		return partenza_tipologia_select;
	}
