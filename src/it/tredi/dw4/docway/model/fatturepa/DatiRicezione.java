...
public class DatiRicezione extends XmlEntity {
	...
	public XmlEntity init(Document dom) {
		this.riferimentoNumeroLinea 	= XMLUtil.parseStrictAttribute(dom, "datiRicezione/@riferimentoNumeroLinea");
		this.idDocumento 				= XMLUtil.parseStrictAttribute(dom, "datiRicezione/@idDocumento");
		this.data 						= XMLUtil.parseStrictAttribute(dom, "datiRicezione/@data");
		this.numItem 					= XMLUtil.parseStrictAttribute(dom, "datiRicezione/@numItem");
		this.codiceCommessaConvenzione 	= XMLUtil.parseStrictAttribute(dom, "datiRicezione/@codiceCommessaConvenzione");
		this.codiceCUP 					= XMLUtil.parseStrictAttribute(dom, "datiRicezione/@codiceCUP");
		this.codiceCIG 					= XMLUtil.parseStrictAttribute(dom, "datiRicezione/@codiceCIG");
