...
public class DocEditStrutturaInterna extends AclDocEdit {
	...
	private StrutturaInterna struttura_interna = new StrutturaInterna();
	...
	public DocEditStrutturaInterna() throws Exception {
	...
	public void init(Document domDocumento) {
    	...
    	this.struttura_interna.init(XMLUtil.createDocument(domDocumento, "//struttura_interna"));
    	this.struttura_interna.setNrecord(".");
