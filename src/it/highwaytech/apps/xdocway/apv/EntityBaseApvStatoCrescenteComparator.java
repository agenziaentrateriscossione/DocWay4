...
public class EntityBaseApvStatoCrescenteComparator implements Comparator<EntityBaseApv> {
    ...
    public int compare(EntityBaseApv o1, EntityBaseApv o2) {
		if(o1.getStatoAvanzamentoApv() == null) {
			...
			if(o2.getStatoAvanzamentoApv() == null)
				return 1;
			return o1.getStatoAvanzamentoApv().fieldForOrder() - o2.getStatoAvanzamentoApv().fieldForOrder();			
		}
    }
}
