...
public class DatiContratto extends XmlEntity {
	...
	public XmlEntity init(Document dom) {
		this.riferimentoNumeroLinea 	= XMLUtil.parseStrictAttribute(dom, "datiContratto/@riferimentoNumeroLinea");
		this.idDocumento 				= XMLUtil.parseStrictAttribute(dom, "datiContratto/@idDocumento");
		this.data 						= XMLUtil.parseStrictAttribute(dom, "datiContratto/@data");
		this.numItem 					= XMLUtil.parseStrictAttribute(dom, "datiContratto/@numItem");
		this.codiceCommessaConvenzione 	= XMLUtil.parseStrictAttribute(dom, "datiContratto/@codiceCommessaConvenzione");
		this.codiceCUP 					= XMLUtil.parseStrictAttribute(dom, "datiContratto/@codiceCUP");
		this.codiceCIG 					= XMLUtil.parseStrictAttribute(dom, "datiContratto/@codiceCIG");
