...
/**
 * Doc in partenza di tipo offerta (repertorio personalizzato)
 * 
 * @author mbernardini
 */
public class Offerta extends Partenza {

	// campi specifici del doc in partenza di tipo Offerta
	...
	public XmlEntity init(Document dom) {
		...
		// inizializzazione dei parametri specifici dell'offerta
	...
	public Map<String, String> asFormAdapterParams(String prefix, boolean modify, boolean modifyRifEsterni, boolean isRepertorio) {
    	...
    	// invio dei parametri specifici dell'offerta
