...
IwxRuntime.Client = (function() {
	...
	function getIwxDownloadMessage(msg, enablefilteralert) {
		...
		downloadURL += "/common/iwx/setup_iwx.msi";
			...
			if (curImageIndex > -1) {
				...
				if (guid != '') {
					...
					if (siTesto != null && siTesto != undefined && siTesto != '') {
						...
						iwx.printFile(guidarray, 'default', {"TEXTS":[{"TEXT": siTesto, "ANGLE": "90", "FONT_NAME": "Arial", "BOLD": "true", "PERCENT_TOP": "90"}]});
					}
					else {
			...
			iwx.addEvent('HTTPUploadFailed', function(resp) {
				if (nextActionAfterUpload == 'acquireDocsFromScanner') {
					...
					if (uploadErrors == '')
						...
						uploadErrors = uploadErrors + ", " + resp;
				}
			});
