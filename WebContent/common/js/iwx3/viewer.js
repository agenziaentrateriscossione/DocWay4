  ...
  Viewer.prototype = {
    ...
    initImage: function (callback) {
      ...
      getImageSize($image[0], $.proxy(function (naturalWidth, naturalHeight) {
        ...
        width = min((width - 8), naturalWidth);
        height = min((height - 8), naturalHeight);
    ...
    /**
     * Zoom the image adapting to visible width
     *
     */
    zoomWidth: function () {

      this.zoomTo((this.parent.width - 8) / this.image.naturalWidth);
      this.moveTo(4, 4);
    },


    zoomOrig: function () {
	    this.zoomTo((this.image.naturalWidth - 8) / this.image.naturalWidth);
	    this.moveTo(4, 4);
	},

    /**
     * Zoom the image adapting to visible page
     *
     */
    zoomPage: function () {
      this.reset();
	...
	resetCallBack: function (callback) {
	    if (this.isViewed && !this.isPlayed) {
	      this.image = $.extend({}, this.initialImage);
	      this.renderImage(callback);
	    }
	},
