...
public class ShowdocPartenzaDCPP extends ShowdocPartenza {
	...
	public void reload() throws Exception {
		super._reload(FacesContext.getCurrentInstance().getExternalContext().getRequestContextPath() + "/docway/equitalia/showdoc@partenza@DCPP");
	}
