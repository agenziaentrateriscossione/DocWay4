...
public class ShowdocVarieAOL extends ShowdocVarie {
	...
	public void reload() throws Exception {
		super._reload(FacesContext.getCurrentInstance().getExternalContext().getRequestContextPath() + "/docway/rep_standard/showdoc@varie@AOL");
	}
