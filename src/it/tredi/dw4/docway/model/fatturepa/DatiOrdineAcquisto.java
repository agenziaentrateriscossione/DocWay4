...
public class DatiOrdineAcquisto extends XmlEntity {
	...
	public XmlEntity init(Document dom) {
		this.riferimentoNumeroLinea 	= XMLUtil.parseStrictAttribute(dom, "datiOrdineAcquisto/@riferimentoNumeroLinea");
		this.idDocumento 				= XMLUtil.parseStrictAttribute(dom, "datiOrdineAcquisto/@idDocumento");
		this.data 						= XMLUtil.parseStrictAttribute(dom, "datiOrdineAcquisto/@data");
		this.numItem 					= XMLUtil.parseStrictAttribute(dom, "datiOrdineAcquisto/@numItem");
		this.codiceCommessaConvenzione 	= XMLUtil.parseStrictAttribute(dom, "datiOrdineAcquisto/@codiceCommessaConvenzione");
		this.codiceCUP 					= XMLUtil.parseStrictAttribute(dom, "datiOrdineAcquisto/@codiceCUP");
		this.codiceCIG 					= XMLUtil.parseStrictAttribute(dom, "datiOrdineAcquisto/@codiceCIG");
