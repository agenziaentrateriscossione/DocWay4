...
public class DocEditModifyAoo extends AclDocEdit {
	...
	public boolean checkRequiredField(){
		...
		if (aoo.getEmailPrincipale() == null || "".equals(aoo.getEmailPrincipale().trim())) {
			this.setErrorMessage("templateForm:aoo_emailPrincipale_input", I18N.mrs("acl.requiredfield") + " '" + I18N.mrs("acl.email_principale") + "'");
			result = true;
		}
