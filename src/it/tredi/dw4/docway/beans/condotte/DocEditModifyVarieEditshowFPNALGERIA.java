...
public class DocEditModifyVarieEditshowFPNALGERIA extends DocEditModifyVarie {
	...
	public DocEditModifyVarieEditshowFPNALGERIA() throws Exception {
		super();
	}
	...
	public String saveDocument() throws Exception {
		try {
			...
			ShowdocVarieFPNALGERIA showdocVarieFPNALGERIA = new ShowdocVarieFPNALGERIA();
			showdocVarieFPNALGERIA.getFormsAdapter().fillFormsFromResponse(response);
			showdocVarieFPNALGERIA.init(response.getDocument());
			showdocVarieFPNALGERIA.loadAspects("@varie", response, "showdoc");
			setSessionAttribute("showdocVarieFPNALGERIA", showdocVarieFPNALGERIA);
			
			return "condotte_showdoc@varie@FPNALGERIA@reload";
		}
		catch (Throwable t) {
