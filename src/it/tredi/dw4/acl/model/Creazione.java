...
public class Creazione extends XmlEntity {
    ...
    public Creazione init(Document domCreazione) {
    	...
    	this.uff_oper 		= XMLUtil.parseAttribute(domCreazione, "creazione/@uff_oper");
    	this.cod_uff_oper 	= XMLUtil.parseAttribute(domCreazione, "creazione/@cod_uff_oper");
