...
public class DocEditFascicolo extends DocWayDocedit {
	...
	public String getInsFascicoloTitle() {
		...
		if (descrizioneFascicoloCustom == null || descrizioneFascicoloCustom.equals(""))
			...
			return descrizioneFascicoloCustom + " - " + I18N.mrs("dw4.ins_sottofascicoli") + " - " + I18N.mrs("acl.insert");
		else if (numDots == 2) //è un inserto
			return descrizioneFascicoloCustom + " - " + I18N.mrs("dw4.ins_inserti") + " - " + I18N.mrs("acl.insert");
		else if (numDots == 3) //è un annesso
			return descrizioneFascicoloCustom + " - " + I18N.mrs("dw4.ins_annessi") + " - " + I18N.mrs("acl.insert");
		else
