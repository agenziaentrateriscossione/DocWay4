...
public class DocEditModifyInterno extends DocEditDoc {
	...
	private final String DEFAULT_INTERNO_TITLE = "dw4.mod_tra_uffici";
	
	public DocEditModifyInterno() throws Exception {
	...
	public boolean checkRequiredField() {
		...
		if (!getFormsAdapter().checkBooleanFunzionalitaDisponibile("docRPAEreditabile", false)) {
			if (getDoc().getAssegnazioneRPAM() == null || 
				...
				this.setErrorMessage(fieldIds, I18N.mrs("dw4.occorre_valorizzare_il_campo_mittente"));
				result = true;
			}
		}
