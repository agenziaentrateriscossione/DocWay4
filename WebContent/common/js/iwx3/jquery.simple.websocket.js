...
var __DUMMY_PROT_ADAPTER__ = (function(){
  ...
  if (typeof module === "object" && typeof module.exports === "object") {
    ...
    SimpleWebSocket.prototype = {
         ...
         _webSocket: function(opt) {
            ...
            self._protocolAdapter = opt.protocolAdapter || __DUMMY_PROT_ADAPTER__;

            var pts = self._protocolAdapter.protocols();

            opt.protocols = pts != '' ? pts :  opt.protocols;
            ...
            // protocl needs
            ws.binaryType = opt.binaryType || "arraybuffer";

            $(ws).bind('open', function(e) {
                if (opt.open) {
                	opt.open.call(this, e);
                }
            }).bind('close', function(e) {
                if (opt.close) {
                	opt.close.call(this, e);
                }
            }).bind('message', function(e) {
            	if (opt[e.type]) {
                        opt[e.type].call(this, self._protocolAdapter.decode(e.originalEvent.data));
                }
         ...
         _connect: function() {
            ...
            this._ws = this._webSocket($.extend(this._opt, {
                ...
                close: function(e) {
                	...
                	if(self._opt.onClose){
                		self._opt.onClose.apply(self, [e]);
                	}
                },
                ...
                error: function(e) {
                    ...
                    if(self._opt.onError){
                    	self._opt.onError.apply(self, [e]);
                	}
                }
            }));
            return attempt.promise();
         ...
         _send: function(data) {
             ...
             (function(json) {
                 self._reConnect.apply(self, []).done(function(ws) {
                     ws.send(self._protocolAdapter.encode(json));
